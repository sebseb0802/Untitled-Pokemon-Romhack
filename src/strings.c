...
const u8 gText_DexHoenn[] = _("Menai");
...
const u8 gText_Starter1[] = _("Tepig");
const u8 gText_Starter2[] = _("Totodile");
const u8 gText_Starter3[] = _("Turtwig");