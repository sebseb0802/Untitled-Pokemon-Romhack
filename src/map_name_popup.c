...
{
    [MAPSEC_LATILYN_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KAZANI_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SATATSU_TOWN] = MAPPOPUP_THEME_BRICK,
    ...
    [MAPSEC_KAZANI_PASS] = MAPPOPUP_THEME_STONE,
