...
{
    [MAPSEC_MARIAN_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KATSIKKI_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RETSU_TOWN] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_PIRKA_CITY] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_KATSIKKI_PASS] = MAPPOPUP_THEME_STONE,
